...
public class SwordInit {
    ...
    public static void init() {
        ...
        EMERALD_SWORD = SWORD_REGISTER.registerSword(new SwordHolder(ToolMaterials.EMERALD, 7f, 1.5f, "emerald_sword"));
        GLOWSTONE_SWORD = SWORD_REGISTER.registerSword(new SwordHolder(ToolMaterials.GLOWSTONE, 4f, 2f, "glowstone_sword"));
        LAPIS_SWORD = SWORD_REGISTER.registerSword(new SwordHolder(ToolMaterials.LAPIS, 5f, 1f, "lapis_sword"));
        OBSIDIAN_SWORD = SWORD_REGISTER.registerSword(new SwordHolder(ToolMaterials.OBSIDIAN, 12f, 0.5f,"obsidian_sword"));
        REDSTONE_SWORD = SWORD_REGISTER.registerSword(new SwordHolder(ToolMaterials.REDSTONE, 9f, 1.1f, "redstone_sword"));
