...
import org.eu.awesomekalin.the_pros_game.pickaxes.*;
...
public class PickaxeInit {
    ...
    public static RegistrySupplier<Item> REDSTONE_PICKAXE = PICKAXES.register("redstone_pickaxe", RedstonePickaxe::new);
}
